...
const StyledInput = styled.input`
    ...
    &:focus {
        /* TODO: add teal to color lib */
        color: #0ca678;
        border-bottom: 1px solod ${palette.gray[7]};
    }
    ...
    return (
        <AuthFormBlock>
            ...
            <form onSubmit={onSubmit}>
                ...
                {type === 'register' && (
                    <StyledInput autoComplete="new-password" name="passwordConfirm" placeholder="Confirm PW" type="password" onChange={onChange} value={form.passwordConfirm} />
                )}
